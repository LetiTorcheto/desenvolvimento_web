...
import { addToCart } from "../redux/slices/carrinhoSlice";
        ...
        {loading ? (
          ...
          <div>
            ...
            <Row>
              <Col md={6}>
                <h4>Avaliações</h4>
                {product.reviews.length === 0 && <p>teste</p>}
                <ListGroup variant="flush">
                  {product.reviews.map((review) => (
                    <ListGroup.Item key={review._id}>
                      <strong>{review.name}</strong>
                      {/* <Rating color={"#f8e825"} value={review.rating} /> Removido */}
                  ...
                  <ListGroup.Item>
                    ...
                    {/* {loadingProductReview && <Loader />} Removido */}
                    ...
                    {userDetails ? (
                      <Form onSubmit={submitHandler}>
                        ...
                        <Button
                          // disabled={loadingProductReview} Removido
                          type="submit"
                          variant="primary"
                        >
                          Enviar
